        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              height: 23*fem,
              child: Image.asset(
                'assets/page-1/images/group-2-GiM.png',
                width: 40*fem,
                height: 23*fem,
              ),
            ),
            Container(
              // autogroupfcadpB3 (LBiqKt4RF9X7mECF3ofCAD)
              width: double.infinity,
              height: 588*fem,
              child: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    child: Align(
                      child: SizedBox(
                        ...
                        height: 110*fem,
                        child: Image.asset(
                          'assets/page-1/images/account-CHo.png',
                          width: 106.67*fem,
                          height: 110*fem,
                        ),
                      ),
